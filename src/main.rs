...
fn main() {
        let sphere = Sphere::new(Point3D::new(0.0, 0.0, -50.0), 40.0,
                                 Material::new(RGBColor::new(1.0, 0.0, 0.0)));
        let sphere2 = Sphere::new(Point3D::new(000.0, -100.0, -20.0), 100.0,
        ...
        let mut world = World::new(ViewPlane::new(1000, 1000, 1.0/10.0), RGBColor::new(0.0, 0.0, 0.0));
        ...
        tracer.render(&world).save("./img2.jpeg").unwrap();
}
